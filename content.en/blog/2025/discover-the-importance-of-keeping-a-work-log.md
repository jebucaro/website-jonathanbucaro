...
{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-create-vault.webp" captions="Pantalla de bienvenida de la aplicación Obsidian que muestra diversas opciones, destacando la opción de crear una nueva bóveda.|Opciones dentro de 'Crear una nueva bóveda' en la aplicación Obsidian, donde se debe especificar el nombre de la bóveda y la ubicación." caption="Obsidian - Crea una bóveda" >}}
...
{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-enable-community-plugins.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-enabled.webp" captions="Configuración de Obsidian en la sección de plugins comunitarios, mostrando el botón para habilitar los plugins de la comunidad.|Opción de habilitar los plugins de la comunidad en Obsidian, mostrando el estado activo." caption="Obsidian - Habilita los plugins de la comunidad" >}}

Haz clic en el botón `Browse` y en la ventana desplegable, busca el nombre del plugin. En este caso, `Templater`.

{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-browse.webp" captions="Pantalla para buscar plugins dentro de los plugins de la comunidad en Obsidian, con la búsqueda del plugin 'Templater'." caption="Obsidian - Buscar Plugins" >}}

##### Plugin Templater

{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-install-templater.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-enable-templater.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-templater-enabled.webp" captions="Resultado de la búsqueda del plugin 'Templater' en Obsidian, mostrando el botón para instalar el plugin.|Plugin 'Templater' instalado en Obsidian, mostrando el botón para habilitar el plugin.|Plugin 'Templater' en Obsidian ya instalado y habilitado." caption="Obsidian - Instala y habilita el Plugin Templater" >}}

##### Plugin Calendar

{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-install-calendar.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-calendar-enable.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-calendar-enabled.webp" captions="Resultado de la búsqueda del plugin 'Calendar' en Obsidian, mostrando el botón para instalar el plugin.|Plugin 'Calendar' instalado en Obsidian, mostrando el botón para habilitar el plugin.|Plugin 'Calendar' en Obsidian ya instalado y habilitado." caption="Obsidian - Instala y habilita el Plugin Calendar" >}}

##### Plugin Dataview

{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-install-dataview.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-enable-dataview.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-community-plugins-dataview-enabled.webp" captions="Resultado de la búsqueda del plugin 'Dataview' en Obsidian, mostrando el botón para instalar el plugin.|Plugin 'Dataview' instalado en Obsidian, mostrando el botón para habilitar el plugin.|Plugin 'Dataview' en Obsidian ya instalado y habilitado." caption="Obsidian - Instala y habilita el Plugin Dataview" >}}
...
{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-folder-structure.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-template-content.webp" captions="Pantalla principal de Obsidian mostrando la estructura de carpetas para configurar la plantilla de notas diarias y el directorio donde se generarán.|Contenido de la plantilla de notas diarias en Obsidian." caption="Obsildian - Estructura de directorios" >}}
...
{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-create-daily-note-configuration.webp" captions="Configuración del plugin 'Daily Notes' en Obsidian, mostrando donde se debe configurar el formato de fecha del archivo, la ubicación y la opción para crear la nota diaria al abrir la aplicación." caption="Obsidian - Configuración de Daily note" >}}
...
{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-create-templater-configuration.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-create-templater-configuration-folder-templates.webp" captions="Configuración del plugin 'Templater' en Obsidian, mostrando donde se debe configurar la ubicación del directorio de plantillas, habilitar la opción para saltar el cursor a la posición configurada y activar 'Templater' en la creación de un nuevo archivo.|Continuación de configuraciones del plugin 'Templater' en Obsidian, donde se habilitan las plantillas de directorios y se debe configurar una pareja de ubicación y plantilla." caption="Obsidian - Configuración de Templater" >}}
...
{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-open-todays-daily-note.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-todays-daily-note.webp" captions="Pantalla de la aplicación Obsidian, mostrando donde debe ejecutarse la opción para crear una nota diaria.|Nota diaria creada en Obsidian a partir de la plantilla configurada." caption="Obsidian - Crea la nota del día de hoy" >}}
...
{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-expand.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-expand-calendar.webp" captions="Pantalla de la aplicación Obsidian, mostrando donde debe hacer Clic en la opción para expandir diferentes vistas, principalmente para ubicar la vista de calendario.|Pantalla de la aplicación Obsidian, mostrando la vista de Calendario" caption="Obsidian - Vista de calendario" >}}
...
{{< gallery images="/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-source-mode.webp,/images/blog/2025/discover-the-importance-of-keeping-a-work-log/obsidian-reading-view.webp" captions="Pantalla de la aplicación Obsidian, mostrando la vista de código fuente|Pantalla de la aplicación Obsidian, mostrando la vista de lectura" caption="Obsidian - Vista de edición y lectura" >}}
